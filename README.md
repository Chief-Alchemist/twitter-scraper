...
[![Go Reference](https://pkg.go.dev/badge/github.com/Chief-Alchemist/twitter-scraper.svg)](https://pkg.go.dev/github.com/Chief-Alchemist/twitter-scraper) [![Go](https://github.com/Chief-Alchemist/twitter-scraper/actions/workflows/go.yml/badge.svg?branch=master)](https://github.com/Chief-Alchemist/twitter-scraper/actions/workflows/go.yml)
...
```shell
go get -u github.com/Chief-Alchemist/twitter-scraper
```
